...
function file_video(path) {
 const url = window.location.origin + path;
  ...
  player_items += `<li class="mdui-divider"></li>
                   <li class="mdui-menu-item"><a id="copy-link" class="mdui-ripple">Copiar</a></li>`;
  const playBtn = `
      <button class="mdui-btn mdui-ripple mdui-color-theme-accent" mdui-menu="{target:'#player-items'}">
        <i class="mdui-icon material-icons">&#xe039;</i>Ver en Reproductor Externo<i class="mdui-icon material-icons">&#xe5cf;</i>
      </button>
